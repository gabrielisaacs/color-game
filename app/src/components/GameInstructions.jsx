...
const GameInstructions = ({ lastResult, isPlaying }) => {
  return (
    <div>
      <div className={`flex flex-col text-2xl mx-auto my-8 items-center justify-center gap-4
        ...
        {!isPlaying ? (
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-base text-gray-700 max-w-2xl text-center space-y-2">
