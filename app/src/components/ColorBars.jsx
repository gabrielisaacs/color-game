  ...
  return (
    <div className='mx-auto flex flex-wrap gap-4 w-[40rem]'>
      <button
        ...
        className={`h-[5rem] w-full font-bold shadow-lg border-neutral-900 border 
          border-opacity-30 rounded-md text-white text-2xl 
      ...
      <div className="grid grid-cols-3 grid-rows-2 gap-4 w-full">
        {gameState.colors?.options.map((color, index) => (
          <button
            ...
            className={`h-[5rem] shadow-lg border-neutral-900 border border-opacity-30 
